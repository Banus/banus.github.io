...
I graduated from [Politecnico di Milano](https://www.polimi.it/en) with a Master's degree in Computer Science and Engineering, where I worked on human motion tracking from video sequences under the supervision of [Prof. Marco Marcon](https://marconlab.deib.polimi.it/). I also worked in there as a reasearch assistant on 3D reconstruction and image retrieval methods as part of the [Image and Sound Processing Lab (ISPL)](http://ispl.deib.polimi.it/).
